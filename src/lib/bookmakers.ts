...
export const bookmakers: Record<string, Bookmaker> = {
  bet365: {
    ...
    brand: "Bet365",
    color: "#027a3e",
    offerHref: "https://www.everytip.co.uk/go/bet365",
    rating: 4.8,
  ...
  betfred: {
    ...
    brand: "Betfred",
    color: "#092c74",
    offerHref: "https://www.everytip.co.uk/go/betfred",
    rating: 4.5,
  ...
  betway: {
    ...
    brand: "Betway",
    color: "#111111",
    offerHref: "https://www.everytip.co.uk/go/betway",
    rating: 4.2,
  ...
  quinnbet: {
    ...
    brand: "QuinnBet",
    color: "#103b7a",
    offerHref: "https://www.everytip.co.uk/go/quinnbet",
    rating: 4.1,
  ...
  spreadex: {
    ...
    brand: "Spreadex",
    color: "#003f2e",
    offerHref: "https://www.everytip.co.uk/go/spreadex",
    rating: 4.4,
  ...
  betwright: {
    ...
    brand: "BetWright",
    color: "#18224a",
    offerHref: "https://www.everytip.co.uk/go/betwright",
    rating: 3.6,
  ...
  fafabet: {
    ...
    brand: "Fafabet",
    color: "#7a0026",
    offerHref: "https://www.everytip.co.uk/go/fafabet",
    rating: 2.7,
  ...
  netbet: {
    ...
    brand: "NetBet",
    color: "#004b9b",
    offerHref: "https://www.everytip.co.uk/go/netbet-50",
    rating: 4.0,
  ...
  "10bet": {
    ...
    brand: "10Bet",
    color: "#101820",
    offerHref: "https://www.everytip.co.uk/go/10bet",
    rating: 3.9,
  ...
  "william-hill": {
    ...
    brand: "William Hill",
    color: "#0b3d91",
    offerHref: "https://www.everytip.co.uk/go/william-hill",
    rating: 4.6,
    tagline: "British high-street institution with a strong football and racing product.",
    established: "1934",
    license: "UKGC",
    minDeposit: "\u00a310",
    payout: "1 to 5 business days",
    ...
    bonus: {
      ...
      terms: "New customers only. Min deposit \u00a310. Free bets paid as 4 x \u00a310 tokens. T&Cs apply. 18+. BeGambleAware.org.",
      wagering: "1x",
      expiry: "30 days",
    },
    pros: [
    ...
    sections: [
      {
        ...
        body: `<p>William Hill offers solid football coverage across the Premier League, Championship and Champions League with deep markets on top matches, plus strong racing coverage and regular price boosts.</p>`,
      },
      {
        id: "app",
        title: "App and mobile experience",
        body: `<p>The William Hill app is dependable, though not as polished as Bet365. It remains a practical choice for bettors who value a familiar UK bookmaker and shop-linked heritage.</p>`,
      },
      {
        id: "banking",
        title: "Deposits, withdrawals and security",
        body: `<p>Deposits are instant with mainstream methods. Withdrawals depend on payment type and may take longer for bank transfers.</p>`,
      },
      {
        id: "support",
        title: "Customer support",
        body: `<p>William Hill offers standard online help channels and remains one of the best-known support names in UK betting.</p>`,
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Yes, William Hill commonly promotes best odds guaranteed on UK and Irish racing, subject to current terms.",
      },
      {
        q: "Who is William Hill best for?",
        a: "William Hill suits football and racing bettors who prefer an established UK bookmaker.",
      },
    ],
    verdict: `William Hill remains a strong established bookmaker, but it is not one of the 10 current Oddstips free-bets cards. Keep this page as an evergreen review route or refresh it when William Hill returns to the offer table.`,
  },
};
